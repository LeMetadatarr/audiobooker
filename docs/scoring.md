...
Every `AudioBook` returned by a `search*()` call carries a `score` field (a
value from 0.0 to 1.0) computed by `score_book()`.
...
|---|---|---|---|---|
| `search` | 55% | 30% | 10% | 5% |
| `search_by_title` | 100% | n/a | n/a | n/a |
| `search_by_author` | n/a | 100% | n/a | n/a |
| `search_by_tag` | n/a | n/a | 100% | n/a |
| `search_by_narrator` | n/a | n/a | n/a | 100% |
...
(case-insensitive), normalized to a value from 0.0 to 1.0.
...
---
[← Unified Search](search.md) · [Home](README.md) · [Sources →](sources.md)
